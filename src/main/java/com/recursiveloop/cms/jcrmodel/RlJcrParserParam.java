...
@Node(jcrType = "rlt:parserParam")
public class RlJcrParserParam {
  private String m_rlName;
  private String m_rlValue;

  public RlJcrParserParam() {}

  public RlJcrParserParam(RlJcrParserParam cpy) {
    m_rlName = cpy.m_rlName;
    m_rlValue = cpy.m_rlValue;
  }

  public RlJcrParserParam(String name, String value) {
    m_rlName = name;
    m_rlValue = value;
  }
